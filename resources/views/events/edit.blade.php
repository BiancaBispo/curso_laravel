{{--
    Aqui é a tela do EDITAR EVENTO, onde ao apertar no link do nav será direcionado por aqui
...
@section('content')
    ...
    <div id="event-create-container" class="col md-5 offset-md-1">{{--aqui arruma as linhas ultrapassada do link--}}
        ...
        <form action="/events/update/{{ $event->id }}" method="POST" enctype="multipart/form-data">
            ...
            @method('PUT'){{--Chamando o método para editar o banco--}}

            {{--Fazer uma Pré-view da imagem que ela já tem no banco--}}
